...
int main() {
    ...
    int myAge = 69;                // This is an integer variable that stores your age.
    ...
    double height = 200.0;         // This is a double variable that stores a floating-point number, representing height in centimeters.
    float weight = 40.5f;          // This is a float variable, similar to double but with less precision, representing weight in kilograms.
